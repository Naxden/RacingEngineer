...
void ATrackGenerator::DoWork(const TArray<FColor>& HeightTextureColors, const USplineComponent* TrackSpline, const FVector& VertScale, const
                             FOnWorkFinished Callback)
{	
	CreateMeshOnSpline(TrackSpline);
