...
ARacingEngineerSportsCar::ARacingEngineerSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = URacingEngineerSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = URacingEngineerSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = URacingEngineerSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = URacingEngineerSportsWheelRear::StaticClass();
