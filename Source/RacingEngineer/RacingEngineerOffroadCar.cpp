...
ARacingEngineerOffroadCar::ARacingEngineerOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = URacingEngineerOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = URacingEngineerOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = URacingEngineerOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = URacingEngineerOffroadWheelRear::StaticClass();
